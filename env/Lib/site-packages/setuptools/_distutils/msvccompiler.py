...
class MSVCCompiler(CCompiler):
    ...
    def runtime_library_dir_option(self, dir):
        raise DistutilsPlatformError(
            "don't know how to set runtime locallibrary search path for MSVC++"
        )
    ...
    def find_library_file(self, dirs, lib, debug=0):
        # Prefer a debugging locallibrary if found (and requested), but deal
    ...
    def set_path_env_var(self, name):
        ...
        if name == "lib":
            p = self.get_msvc_paths("locallibrary")
        else:
