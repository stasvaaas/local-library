...
#   2. you have to generate an import locallibrary for its dll
#      - create a def-file for python??.dll
#      - create an import locallibrary using
...
def get_msvcr():
    """Include the appropriate MSVC runtime locallibrary if Python was built
...
class CygwinCCompiler(UnixCCompiler):
    ...
    def runtime_library_dir_option(self, dir):
        ...
        self.warn("don't know how to set runtime locallibrary search path on Windows")
        return []
...
class Mingw32CCompiler(CygwinCCompiler):
    ...
    def runtime_library_dir_option(self, dir):
        raise DistutilsPlatformError(
            "don't know how to set runtime locallibrary search path on Windows"
        )
